            ...
            <form id="checkout-form" action="#">
              ...
              <div class="checkout-progress">
                ...
                <div class="progress-steps-wrapper">
                  ...
                  <div id="progress-review" class="checkout-step active">
                    <div class="checkout-step-icon">
                      <i class="bi-check"></i>
                    </div>
                    <h1>Review</h1>
              ...
              <!-- checkout form fields - BASIC INFO -->
              ...
              <fieldset>
                ...
                <div class="input-wrapper inline">
                  ...
                  <label for="shipping-expedited" class="radio-container large">
                    <input type="radio" id="shipping-expedited" name="shipping" value="expedited">
                    <div class="radio"></div>
              ...
              <fieldset>
                ...
                <div class="input-wrapper inline">
                  ...
                  <label for="payment-new-card" class="radio-container large">
                    <input type="radio" name="payment-method" id="payment-new-card" required checked>
                    <div class="radio"></div>
                    New Card
                  ...
                  <label for="payment-visa-1234" class="radio-container large">
                    <input type="radio" name="payment-method" id="payment-visa-1234" disabled>
                    <div class="radio"></div>
                    VISA ending in 1234
